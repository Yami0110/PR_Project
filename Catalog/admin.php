...
<head>
    ...
    <title>Catalog-Z (Admin page) Main page</title>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link nav-link-1 active" aria-current="page" href="admin.php">Main</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12" style="width: 100%;">
                <div class="tm-bg-gray tm-video-details">
                    <div class="text-center mb-5">
                        <a href="list.php?mediaType=photos" class="btn btn-primary" style="width: 200px">Photos</a><br/><br/>
                        <a href="list.php?mediaType=videos" class="btn btn-primary" style="width: 200px">Videos</a><br/><br/>
                        <a href="mails_list.php" class="btn btn-primary" style="width: 200px">Mails</a>
                    </div> 
                </div>
            </div>
        </div>
