...
<head>
    ...
    <title>Catalog-Z (Admin page) Message</title>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row tm-mb-90">
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12" style="width: 100%;">
                <h2 class="tm-text-primary mb-5">Message</h2>
                <h3 class="tm-text-primary"><?php echo $message[0]['message']; ?></h3><br>
                <a href="mails_list.php" class="btn btn-primary" style="width: 200px; margin-left: 20px;">Back</a><br/><br/>
            </div>
        </div>
    </div>
