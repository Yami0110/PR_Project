...
$employerItems = $db->getEmployers();
$subjectItems = $db->getSubjects();
    ...
    <div class="container-fluid tm-mt-60">
        <div class="row tm-mb-50">
            <div class="col-lg-4 col-12 mb-5">
                ...
                <form id="contact-form" action="send_message.php" method="POST" class="tm-contact-form mx-auto">
                    ...
                    <div class="form-group">
                        <select class="form-control" name="subject_id" id="subject_id">
                            ...
                            ?>
                            <option value="<?php echo $subjectItem["id"]; ?>"><?php echo $subjectItem["subject"]; ?></option>
                            <?php
                                }
                            ?>
                        </select>
        ...
        <div class="row tm-mb-74 tm-people-row">
            <?php
                foreach ($employerItems as $employerItem) {
            ?>
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <img src="<?php echo $employerItem["image_link"]; ?>" alt="Image" class="mb-4 img-fluid">
                <h2 class="tm-text-primary mb-4"><?php echo $employerItem["name"]; ?> <?php echo $employerItem["surname"]; ?></h2>
                <h3 class="tm-text-secondary h5 mb-4"><?php echo $employerItem["position"]; ?></h3>
                <p class="mb-4">
                    <?php echo $employerItem["about"]; ?>
                </p>
                <ul class="tm-social pl-0 mb-0">
                    <?php
                        $snsItems = $db->getSns($employerItem["id"]);
                        foreach ($snsItems as $snsItem) {
                    ?>
                        <li><a href="<?php echo $snsItem["sns_link"]; ?>"><i class="<?php echo $snsItem["icon"]; ?>"></i></a></li>
                    <?php
                        }
                    ?>
                </ul>
